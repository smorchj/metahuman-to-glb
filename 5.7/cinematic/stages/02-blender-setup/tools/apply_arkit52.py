...
_REGION_RULES = [
    ...
    # 5.6 MI_HeadSynthesized_* OR 5.7 Optimized's MI_Face_Skin_Baked_LOD*_VT
    ("head",          lambda n: "headsynthesized" in n
                                or "face_skin_baked" in n
                                or "head_lod" in n),
    ("teeth",         lambda n: "teeth" in n),
    # 5.6 eyerefractive_l / _r OR 5.7 mi_eyel_baked / mi_eyer_baked
    ("eye_left",      lambda n: ("eyerefractive" in n and n.rstrip("0123456789_").endswith("_l"))
                                or "mi_eyel_baked" in n or "eyeleft_shader" in n),
    ("eye_right",     lambda n: ("eyerefractive" in n and n.rstrip("0123456789_").endswith("_r"))
                                or "mi_eyer_baked" in n or "eyeright_shader" in n),
]
